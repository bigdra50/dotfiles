...
return {
  keys = {
    ...
    { key = '!', mods = 'SHIFT|LEADER', action = act.EmitEvent 'user-defined-0' },
    ...
    { key = '&', mods = 'SHIFT|LEADER', action = act.CloseCurrentTab{ confirm = true } },
    { key = '\'', mods = 'SHIFT|ALT|CTRL', action = act.SplitVertical{ domain =  'CurrentPaneDomain' } },
    ...
    { key = 'o', mods = 'LEADER', action = act.PaneSelect{ alphabet =  '', mode =  'SwapWithActive', show_pane_ids = false } },
    { key = 'p', mods = 'SHIFT|CTRL', action = act.ActivateCommandPalette },
    { key = 'q', mods = 'SHIFT|CTRL', action = act.QuitApplication },
