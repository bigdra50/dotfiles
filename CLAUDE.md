...
- 効果を語るときは中身を書く。「効率が上がる」で止めず、何がどれだけ短くなるかまで書く
- 否定の対比から入らない。まず主張を言い切り、他の選択肢との対比は誤解を招くときだけ足す
- 主語を省略しない。誰が何をするのかを文ごとに確定させる
- 同じ文末を続けない。「〜する」が並んだら片方を体言止めか別の動詞に変える
- 文体を混ぜない。1 つの文書では常体か敬体のどちらかに統一する
